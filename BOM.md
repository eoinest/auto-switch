...
- **Electronics holder:** [mounting guide](docs/electronics-retention.md). Keep the v4 carrier and wall bracket; the latest [v6 single-bar preview](hardware/cad/battery-retention-v6/README.md) simplifies battery retention and reuses two M3 × 35 screws/nuts. Optional v5 shims address sideways play. The [booster clips still need measured PCB dimensions](hardware/cad/battery-retention-v6/booster-fit-audit.md). Two M1.6 screws/nuts attach the S2 through its factory holes; M3 hardware secures the retainers and converter jaws.
