...
```sh
mpremote fs cp firmware/main.py firmware/control.py firmware/calibration.py firmware/hardware.py firmware/http_api.py firmware/gateway_client.py firmware/bench.py firmware/maintenance.py :
