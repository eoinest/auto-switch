...
For a separate live USB/servo test, use the [explicit split-supply mode](reviews/wiring-decision-2026-09-08.md): remove and insulate the booster-to-S2 VBUS lead, keep ground common, and manage the signal when either device is unpowered. This is different from the isolated programming procedure above.
