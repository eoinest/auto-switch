# Historical Pico / gated-power BOM

This list belongs to an earlier design. Use the [current POC BOM](../../BOM.md) for the S2 Mini build. Historical purchase and fit statements below do not describe the current inventory.
