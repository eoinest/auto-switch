...
**Electronics carrier review:** [Revised S2/AA tray, fit-test STL files and outstanding measurements](docs/electronics-carrier-v2.md). Use this revision instead of the earlier tray; the converter remains dimensionally unverified.
